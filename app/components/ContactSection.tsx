				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<motion.a
								href="mailto:aykutalpozgur@hotmail.com"
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
								<motion.a
									href="https://github.com/DiscountLegolas"
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@DiscountLegolas</p>
									</div>
								</motion.a>
								<motion.a
									href="https://www.linkedin.com/in/ozguraykutalp"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									<div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
									...
									<div>
										...
										<p className="text-sm text-gray-400">Özgür Aykutalp</p>
									</div>
								</motion.a>
							</div>
						</div>
