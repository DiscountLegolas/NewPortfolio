			...
			<div className="relative z-10 max-w-4xl w-full mx-4">
				...
				>
					...
					<div className="font-mono">
						...
						<h1 className="text-4xl md:text-5xl font-bold mt-2 mb-4">Özgür Aykutalp</h1>
						<p className="text-gray-400 mb-2">Backend Engineer</p>
						<p className="text-green-500">$ about</p>
						<p className="text-gray-300 mb-4">Software developer with over 2 years of hands-on experience in building web applications, enhancing system performance, and contributing to AI-driven solutions. Specialized in backend development and database management, with a proven track record of designing scalable architectures and integrating intelligent features into production systems.</p>
