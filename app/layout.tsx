...
export const metadata: Metadata = {
	title: 'Özgür Aykutalp - Backend Developer',
	description:
	...
	authors: [{ name: 'Özgür Aykutalp' }],
	creator: 'Özgür Aykutalp',
	openGraph: {
		title: 'Özgür Aykutalp - Backend Developer Portfolio',
		...
		url: 'https://ozguraykutalp.com',
		siteName: 'Özgür Aykutalp - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'Özgür Aykutalp - Backend Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
